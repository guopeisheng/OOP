...
public class Randomizer implements IRandomizer {
	...
	/**
	 * Returns a random integer greater than or equal to min and less than or equal
	 * to max.
	 * 
	 ...
	 * absolute value of the velocity (speed) within the bound (inclusive) defined
	 * by rect. Thus the resultant velocity may be negative. The given Rectangle
	...
	/**
	 * Returns a random choice of one of two objects, x and y, where probX is the
	 * probability that x will be picked.
	 * 
