...
public interface IRandomizer {
	 ...
	 * @param rectangle The bounds for the x and y values of the created Point
	 * @return A Point object whose x and y are subject to the given bounds
	 */
	public Point randomLoc(Rectangle rectangle);

	/**
	 * Generates a random location point subject to the constraint.
	 * @param dimension The bounds for the x and y values of the created Point
	 * @return A Point object whose x and y are subject to the given bounds
	 */
	public Point randomLoc(Dimension dimension);
	 ...
	 * @param rectangle The bounds for the absolute value of the velocity in the x and y directions.
	 * @return a Point object with x and y subject to the given bounds.
	 */
	public Point randomVel(Rectangle rectangle);
